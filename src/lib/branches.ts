...
export const branches: Branch[] = [
  {
    ...
    description:
      "Recognized as one of Ahmedabad's most dynamic fitness hubs, Hirawadi is where transformation stories are written, discipline is forged, and a culture of fitness thrives every day..",
    longDescription: [
      "SFW Hirawadi is where the SFW legacy truly came to life. Established as one of the earliest branches in Ahmedabad, it has helped countless members begin and transform their fitness journeys through discipline, consistency, and a motivating environment. Known for its strong presence in the Hirawadi area, this branch continues to stand as a reliable and energetic fitness destination",
      "The gym is equipped with quality training equipment and offers a well-maintained workout space designed for all fitness levels. From beginners to experienced individuals, members benefit from guidance provided by supportive and experienced trainers who focus on proper technique and steady progress. The environment encourages consistency and helps individuals stay committed to their goals.",
      "Beyond weight training, Hirawadi also offers a variety of fitness activities including group sessions like Zumba and yoga, creating a balanced and engaging workout routine. The gym maintains cleanliness and provides a comfortable space where members can train with focus and energy throughout the week.",
      "The Hirawadi branch is more than just a place to work out — it is a supportive fitness community. Members appreciate the friendly atmosphere, motivating trainers, and positive culture that keeps them coming back every day. This is where consistency turns into results and fitness becomes a lifestyle.",
    ],
    address: "4th floor, Pushpak Arcade, Opp. Hirawadi BRTS Bus Stop, N.H.No. 8 – Ahmedabad",
    addressLine1: "4th floor, Pushpak Arcade",
    addressLine2: "Opp. Hirawadi BRTS Bus Stop, N.H.No. 8",
    city: "Ahmedabad, Gujarat",
    pincode: "380024",
    phone: "+91 77779 95429",
    ...
    features: [
      {
        ...
        description:
          "Equipped with high-quality barbells, plates, and dedicated lifting space designed to support serious strength training and progressive performance..",
        icon: "Shield",
      },
      {
        title: "Cardio Zone",
        description:
          "Equipped with a wide range of treadmills, cross trainers, and bikes, designed to deliver an effective and comfortable cardio workout experience.",
        icon: "Activity",
      },
      {
        title: "Yoga & Recovery Space",
        description:
          "Designed to help you unwind and recover, this space focuses on flexibility, mobility, and mindful training for a complete fitness experience.",
        icon: "Leaf",
      },
      {
        title: "Nutrition Support",
        description:
          "Get personalized diet guidance designed to complement your workouts and maximize your transformation journey.",
        icon: "Salad",
      },
      {
        title: "Functional Training Zone",
        description:
          "A dynamic space equipped for functional workouts, helping improve strength, agility, endurance, and overall athletic performance.",
        icon: "Zap",
      },
      {
        title: "Recovery Zone",
        description:
          "Dedicated space focused on post-workout recovery, helping your body relax, recharge, and perform better in every session.",
        icon: "Thermometer",
      },
    ],
    programs: [
      {
        ...
        description:
          "A structured strength training program focused on core lifts, designed to improve performance, build strength, and ensure consistent progress with expert guidance.",
      },
      {
        ...
        description:
          "A results-driven program combining strength training, high-intensity workouts, and guided nutrition to support effective body transformation over time.",
      },
      {
        ...
        level: "All Levels",
        description:
          "A dynamic training program combining functional movements, agility work, and endurance training to maximize speed, stamina, and performance.",
      },
      {
        title: "Body Transformation",
        duration: "Ongoing",
        level: "Beginner",
        description:
          "Designed to help you manage weight through a mix of low-impact workouts, strength exercises, and consistent nutrition guidance. ",
      },
    ],
    trainers: [
      {
...

  {
    ...
    longDescription: [
      "SFW Maninagar, established to redefine fitness standards in the eastern part of Ahmedabad, has become a go-to destination for individuals serious about their health and transformation. Strategically located in a spacious and easily accessible facility, this branch is designed to deliver a premium workout experience with state-of-the-art equipment and a motivating atmosphere.",
      "One of the standout features of SFW Maninagar is its dedicated women’s training zone — a comfortable, fully equipped, and secure environment tailored to support women in achieving their fitness goals with confidence. From strength machines to functional training setups, the space is built to encourage consistency and growth.",
      "One of the standout features of SFW Maninagar is its dedicated women’s training zone — a comfortable, fully equipped, and secure environment tailored to support women in achieving their fitness goals with confidence. From strength machines to functional training setups, the space is built to encourage consistency and growth",
      "For those with busy lifestyles, SFW Maninagar provides flexible workout options including quick, effective training sessions that fit into any schedule. With a strong community vibe and a results-driven approach, this branch stands by its core belief: train hard, stay consistent, and results will follow. 💪🔥",
    ],
    ...
    features: [
      {
        title: "Exclusive Women’s Fitness Zone",
        description:
          "A dedicated, fully air-conditioned floor designed exclusively for women, equipped with modern resistance machines, functional training tools, and guided support for a and confident workout experience.",
        icon: "Heart",
      },
      {
        title: "Elite CrossFit Training",
        description:
          "Experience high-performance CrossFit training with open rigs, Olympic lifting setups, rowing machines, and certified coaches delivering structured daily WOD sessions for all fitness levels.",
        icon: "Zap",
      },
      {
        title: "Quick HIIT Burn Sessions",
        description:
          "Power-packed 45-minute HIIT workouts running throughout the day, designed for maximum fat burn, endurance building, and perfect for professionals with limited time.",
        icon: "Timer",
      },
      {
        title: "Advanced Strength Arena",
        description:
          "Fully equipped strength training zone featuring Olympic platforms, free weights, and expert guidance to help you build muscle, increase strength, and enhance overall performance.",
        icon: "Dumbbell",
      },
      {
        title: "High-Energy Cycling Studio",
        description:
          "Immersive indoor cycling experience with music-driven sessions, professional trainers, and structured classes that boost stamina and keep you motivated.",
        icon: "Bike",
      },
      {
        title: "Nutrition & Recovery Bar",
        description:
          "In-house juice and supplement bar offering fresh shakes, recovery drinks, and nutrition support to fuel your workouts and accelerate recovery.",
        icon: "Coffee",
      },
    ],
    programs: [
